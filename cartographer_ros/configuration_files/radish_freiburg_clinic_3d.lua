...
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.3375
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = 0.15
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.hit_probability = 0.525075
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.miss_probability = 0.4999
        
        
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 20
--TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 1
--TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 1
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 250
