...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 175
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d .resolution = 0.1

POSE_GRAPH.constraint_builder.sampling_ratio = 1.
POSE_GRAPH.optimize_every_n_nodes = 175
POSE_GRAPH.constraint_builder.min_score = 0.7
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 0.
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 0.
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(120.)
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 2000
