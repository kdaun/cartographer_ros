...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 75000
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.15

POSE_GRAPH.constraint_builder.sampling_ratio = 0.3
POSE_GRAPH.optimize_every_n_nodes = 75000
POSE_GRAPH.constraint_builder.min_score = 0.999
...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 2000000
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.tsdf_range_data_inserter.project_sdf_distance_to_scan_normal = false
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.tsdf_range_data_inserter.truncation_distance = 0.8
