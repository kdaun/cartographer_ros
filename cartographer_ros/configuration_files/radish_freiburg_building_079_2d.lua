...
POSE_GRAPH.constraint_builder.sampling_ratio = 1e-10 --0.1
POSE_GRAPH.optimize_every_n_nodes = 75
POSE_GRAPH.constraint_builder.min_score = 10.9
POSE_GRAPH.global_sampling_ratio = 0.01
POSE_GRAPH.optimization_problem.huber_scale = 1e1
POSE_GRAPH.optimization_problem.odometry_translation_weight = 0
POSE_GRAPH.optimization_problem.odometry_rotation_weight = 0
POSE_GRAPH.constraint_builder.ceres_scan_matcher.occupied_space_weight = 20000
                 

TRAJECTORY_BUILDER.trajectory_builder_2d.use_imu_data = false

TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = true
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 110.15
...
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d .resolution = 0.075
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.tsdf_range_data_inserter.truncation_distance = 0.45
